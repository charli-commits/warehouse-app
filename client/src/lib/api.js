...
export const api = {
  ...
  adjustStock: (id, quantity, notes, user_name, location) => request(`/parts/${id}/adjust`, { method: 'POST', body: { quantity, notes, user_name, location } }),
  ...
  forceReady: (id) => request(`/deliveries/${id}/force-ready`, { method: 'POST' }),
